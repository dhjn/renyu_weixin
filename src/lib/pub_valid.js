...
//email格式 205
  ...
  val_photo_all(val) {
    let rtn = false
    let allowed=['jpg','JPG','gif','png','PNG','jpeg','doc','docx','zip','7z','rar','pdf','txt']
  ...
  val_photo(val) {
    let rtn = false
    let allowed=['jpg','JPG','gif','png','PNG','jpeg']
    for(var i = 0; i < allowed.length;i++){
      if(!(allowed[i]!== val)){
        return true;
      }
  ...
  // 图片上传的验证格式
  val_photo_all_rtn(val) {
    let rtn = false
    let allowed=['jpg','JPG','gif','png','PNG','jpeg','doc','docx','zip','7z','rar','pdf','txt']
    let photo=['jpg','JPG','gif','png','PNG','jpeg']
    let fileType=['doc','docx','zip','7z','rar','pdf','txt']
    if (allowed.includes(val)) {
      if (photo.includes(val)) {
        return 'photo'
      }
      if (fileType.includes(val)) {
        return 'file'
      }
    } else {
      return 'photoFile'
...
//身份证号 207
  val_iden:(ob)=>{
    let rtn = false,
      ...
      aProv = {11:"北京",12:"天津",13:"河北",14:"山西",15:"内蒙古",21:"辽宁",22:"吉林",23:"黑龙江",31:"上海",32:"江苏",33:"浙江",34:"安徽",35:"福建",
        36:"江西",37:"山东",41:"河南",42:"湖北",43:"湖南",44:"广东",45:"广西",46:"海南",50:"重庆",51:"四川",52:"贵州",53:"云南",
...
//台湾身份证号   214
  tw_idenvaild:(ob)=>{
    let rtn=false,idno = $(ob).val(),tw_iden,field=$(ob).attr("dis"),
      //台湾的所有地区编码和验证码如下：英文 县市 / 地区 验证码（数字）
      twareacode= [
        { "code":"A" , "city":"台北市" , "valid":10},
        { "code":"B" , "city":"台中市" , "valid":11},
        { "code":"C" , "city":"基隆市" , "valid":12},
        { "code":"D" , "city":"台南市" , "valid":13},
        { "code":"E" , "city":"高雄市" , "valid":14},
        { "code":"F" , "city":"台北县" , "valid":15},
        { "code":"G" , "city":"宜兰县" , "valid":16},
        { "code":"H" , "city":"桃园县" , "valid":17},
        { "code":"I" , "city":"嘉义市" , "valid":34},
        { "code":"J" , "city":"新竹县" , "valid":18},
        { "code":"K" , "city":"苗栗县" , "valid":19},
        { "code":"L" , "city":"台中县" , "valid":20},
        { "code":"M" , "city":"南投县" , "valid":21},
        { "code":"N" , "city":"彰化县" , "valid":22},
        { "code":"O" , "city":"新竹市" , "valid":35},
        { "code":"P" , "city":"云林县" , "valid":23},
        { "code":"Q" , "city":"嘉义县" , "valid":24},
        { "code":"R" , "city":"台南县" , "valid":25},
        { "code":"S" , "city":"高雄县" , "valid":26},
        { "code":"T" , "city":"屏东县" , "valid":27},
        { "code":"U" , "city":"花莲县" , "valid":28},
        { "code":"V" , "city":"台东县" , "valid":29},
        { "code":"W" , "city":"金门县" , "valid":32},
        { "code":"X" , "city":"澎湖县" , "valid":30},
        { "code":"Y" , "city":"阳明山管理局" , "valid":31},
        { "code":"Z" , "city":"连江县" , "valid":33}
      ];
    if(idno.length != 10){
